...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Baza Academy</title>
        <meta
          name="description"
          content="Learn how Baza Academy collects, uses, and protects your personal information when using our tutoring and learning platform."
        />
      </Head>
      ...
      <div className="container my-5">
        ...
        <h4>9. Contact Us</h4>
        <p>
          If you have any questions or concerns about this Privacy Policy, please contact us at <a href="mailto:support@bazaacademy.com">support@baxaacademy.com</a>.
        </p>
